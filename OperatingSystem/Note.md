...
---
#### 地址结构
![段页式虚拟存储管理系统的地址结构](./res/5.6.3-段页式虚拟存储管理系统的地址结构.png)

---
#### 地址转换
![段页式存储管理系统地址转换](./res/5.6.3-段页式存储管理系统地址转换.png)
...
- 产生6次缺页中断
- $缺页中断率 = \frac{6}{10} = 60\%$
![5.6.3-课堂练习-FIFO](./res/5.6.3-课堂练习-FIFO.png)

##### 使用LRU算法
- 产生5次缺页中断
- $缺页中断率 = \frac{5}{10} = 50\%$
![5.6.3-课堂练习-LRU](./res/5.6.3-课堂练习-LRU.png)

##### 使用OPT算法
- 产生5次缺页中断
- $缺页中断率 = \frac{5}{10} = 50\%$
![5.6.3-课堂练习-OPT](./res/5.6.3-课堂练习-OPT.png)

---
#### 课堂练习2
请求分页管理系统中，假设某进程的页表内容如下表所示。
![5.6.3-课堂练习2](./res/5.6.3-课堂练习2.png)
- 页面大小为4KB
- 一次内存的访问时间是100ns，
- 一次快表（TLB）的访问时间是10ns，
- 处理一次缺页的平均时间为$10^8ns$
