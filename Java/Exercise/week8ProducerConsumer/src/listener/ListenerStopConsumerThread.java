...
public class ListenerStopConsumerThreadTest implements ActionListener {
    ...
    public ListenerStopConsumerThreadTest(ConsumerThread[] t, JFrame f) {
        super();
        threadsConsumer = t;
        frame = f;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        System.out.println("当前消费者开关值为:" + MainFrameProducerConsumerTest.switchConsumerNum);
        if (MainFrameProducerConsumerTest.switchConsumerNum % 2 == 0) {
            MainFrameProducerConsumerTest.buttonC.setText("消费 关");
            ...
            MainFrameProducerConsumerTest.switchConsumerNum = MainFrameProducerConsumerTest.switchConsumerNum + 1;
            System.out.println("消费者开关已关闭.当前消费者开关值为:" + MainFrameProducerConsumerTest.switchConsumerNum);
        }   else{
                MainFrameProducerConsumerTest.buttonC.setText("消费 开");
            JOptionPane.showMessageDialog(frame, "消费者线程正在逐一开启,这需要一定的时间......");
                ...
                MainFrameProducerConsumerTest.switchConsumerNum = MainFrameProducerConsumerTest.switchConsumerNum + 1;
                System.out.println("消费者开关已开启,当前消费者开关值为:" + MainFrameProducerConsumerTest.switchConsumerNum);
            }
