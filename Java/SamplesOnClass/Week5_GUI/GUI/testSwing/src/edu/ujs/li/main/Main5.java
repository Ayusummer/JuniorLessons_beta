...
import edu.ujs.li.listener.CompanyListener;
import edu.ujs.li.listener.VersionListener;
...
public class Main5 {
	...
	public static void main(String[] args) {
		...
		JMenuItem m2_item1 = new JMenuItem("vision");
		  m2_item1.addActionListener(new VersionListener());
		JMenuItem m2_item2 = new JMenuItem("company");
		  m2_item2.addActionListener(new CompanyListener(tArea));
		  menu2.add(m2_item1);  
		  menu2.add(m2_item2);
